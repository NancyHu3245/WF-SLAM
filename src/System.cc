        ...
        mbDeactivateLocalizationMode(false)
{
    ...
    //Loading point cloud mapping parameters
    cout << endl << "Loading point cloud mapping parameters" << endl;
    ...
    //float octo_resolution  = fsSettings["octo_resolution"];
    cout << "resolution:" <<resolution<<endl;
    cout << "meank:" << meank << endl;
    cout << "thresh:" << thresh << endl;
    //cout << "octo_resolution:" << octo_resolution << endl;
